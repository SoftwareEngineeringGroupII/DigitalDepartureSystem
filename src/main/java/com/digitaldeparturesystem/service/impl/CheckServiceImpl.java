...
public class CheckServiceImpl implements ICheckcommitService {
    ...
    @Override
    public ResponseResult addCheckCommitByType(Checkcommit checkcommit) {
        ...
        assert student != null;
        //checkcommit = checkcommitMapper.addCheckCommitByType();
        //return ResponseResult.SUCCESS("显示成功！").setData(new ArrayList<Checkcommit>(){{add()}})
